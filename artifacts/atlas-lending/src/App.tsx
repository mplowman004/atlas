...
function OpportunitiesPage() {
  ...
  return <PageScaffold><PageTitle eyebrow="Current lead queue · source-gated" title="Opportunities" description="Only current, source-verified and lending-qualified evidence can appear here. Monthly Orem permit research is separate and does not establish financing need." />
