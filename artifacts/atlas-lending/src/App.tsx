...
function BriefPanel() {
  ...
  return (
    <PageScaffold>
      <PageTitle eyebrow={`Utah County · ${currentBriefDate()}`} title="Morning brief" description="A clear read on who is showing intent today." action={
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard label="Prioritized opportunities" value={data.counts.opportunities} note="call-ready" icon={Target} accent="green" />
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.18fr_0.82fr]">
        <div className="rounded-2xl border border-[#ded8cd] bg-[#fffdf8] p-6" data-testid="panel-pipeline">
          <SectionHeading title="Pipeline by lending hypothesis" detail="Estimated opportunity value from current signals" />
...
function OpportunitiesPage() {
  ...
  return <PageScaffold><PageTitle eyebrow="Prioritized by fit · 100 records max" title="Opportunities" description="Verified intent signals translated into a next-best lending conversation." action={<div className="flex items-center gap-2 rounded-lg border border-[#ded8cd] bg-[#fffdf8] px-3 py-2 text-xs text-[#77807b]"><Database size={14} className="text-[#a36d25]" /> Utah County coverage</div>} />
